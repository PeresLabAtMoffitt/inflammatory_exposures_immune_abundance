...
## 3 levels factor variable - immunoscore_2018lancet_patients
```{r 3 levels factor variable - immunoscore_2018lancet_patients}
risk_ass <- function(data, type){

    print(paste("RISK ASSESSMENT FOR ->", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High", ":"))
    risk <- eh_test_subtype(label = type,
                M = 2,
                factors = list("refage", "site", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High"),
                data = data)

    print(risk[["or_ci_p"]])

    print(paste("OVERALL PVAL FOR ->", "immunoscore_2018lancet_patients", ":"))
...
## 3 levels factor variable - immunoscore_2018lancet_patients
```{r 3 levels factor variable - immunoscore_2018lancet_patientsb}
risk_ass <- function(data, type){

    print(paste("RISK ASSESSMENT FOR ->", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High", ":"))
    risk <- eh_test_subtype(label = type,
                M = 2,
                factors = list("refage", "site", "mean_tumor.i", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High"),
                data = data)
...
loreg_table_int(data = markers_wTMA, type = "CD3_total")
```
</div>

<div class = "col-md-6">
```{r log reg periph d, results = 'asis'}
# loreg_table_per(data = markers_wTMA, type = "CD3_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
loreg_table_int(data = markers_wTMA, type = "CD3_CD8_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# loreg_table_per(data = markers_wTMA, type = "CD3_CD8_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
loreg_table_int(data = markers_wTMA, type = "CD3_FoxP3_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# loreg_table_per(data = markers_wTMA, type = "CD3_FoxP3_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
loreg_table_int(data = markers_wTMA, type = "CD11b_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# loreg_table_per(data = markers_wTMA, type = "CD11b_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
loreg_table_int(data = markers_wTMA, type = "CD11b_CD15_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# loreg_table_per(data = markers_wTMA, type = "CD11b_CD15_total")
```
</div>
</div>
...
<!-- # model <- multinom(immunoscore_patients ~ BMI_recent_grp, data = markers_wTMA) -->
<!-- # broom::tidy(model) -->
<!-- # exp(coef(model)) -->
<!-- # multinom(immunoscore_patients ~ BMI_recent_grp, data = markers_wTMA) %>% -->
<!-- #   tbl_regression(exponentiate = TRUE) %>% -->
<!-- #   multinom_pivot_wider() -->

<!-- # multireg_table_int(data = markers_wTMA) -->
<!-- ``` -->
<!-- </div> -->
...
<!-- <div class = "col-md-6"> -->
<!-- ```{r, results = 'asis'} -->
<!-- # multireg_table_per(data = markers_wTMA) -->
<!-- ``` -->
<!-- </div> -->
<!-- </div> -->
...
glm_table_int(data = markers_wTMA, type = "percent_CD3_total")
```
</div>

<div class = "col-md-6">
```{r glm periphb, results = 'asis'}
# glm_table_(data = markers_wTMA, type = "percent_CD3_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
glm_table_int(data = markers_wTMA, type = "percent_CD3_CD8_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# glm_table_(data = markers_wTMA, type = "percent_CD3_CD8_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
glm_table_int(data = markers_wTMA, type = "percent_CD3_FoxP3_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# glm_table_(data = markers_wTMA, type = "percent_CD3_FoxP3_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
glm_table_int(data = markers_wTMA, type = "percent_CD11b_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# glm_table_(data = markers_wTMA, type = "percent_CD11b_total")
```
</div>
</div>
...
<div class = "col-md-6">
```{r, results = 'asis'}
glm_table_int(data = markers_wTMA, type = "percent_CD11b_CD15_total")
```
</div>

<div class = "col-md-6">
```{r, results = 'asis'}
# loreg_table_(data = markers_wTMA, type = "percent_CD11b_CD15_total")
```
</div>
</div>
<br>
...
# Fully adjusted models + fullpregnum + ocdur + tubelig + famhist_br_ov
...
## 3 levels factor variable - immunoscore_2018lancet_patients
```{r 3 levels factor variable - immunoscore_2018lancet_patients c}
risk_ass <- function(data, type){

    print(paste("RISK ASSESSMENT FOR ->", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High", ":"))
    risk <- eh_test_subtype(label = type,
                M = 2,
                factors = list("refage", "site", "fullpregnum", "ocdur", "tubelig", "famhist_br_ov", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High"),
                data = data)
...
## 3 levels factor variable - immunoscore_2018lancet_patients
```{r 3 levels factor variable - immunoscore_2018lancet_patients d}
risk_ass <- function(data, type){

    print(paste("RISK ASSESSMENT FOR ->", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High", ":"))
    risk <- eh_test_subtype(label = type,
                M = 2,
                factors = list("refage", "site", "fullpregnum", "ocdur", "tubelig", "famhist_br_ov", "mean_tumor.i", "immunoscore_2018lancet_patients_Intermediate", "immunoscore_2018lancet_patients_High"),
                data = data)
