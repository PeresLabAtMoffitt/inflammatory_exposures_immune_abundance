...
loreg_table_int <- function(data, type){
  ...
  for (i in exp_var){
    ...
    tbl1 <- glm(data[[paste0(type, ".i")]] ~ data[[i]], data = data, family = "binomial") %>%
...
loreg_table_per <- function(data, type){
  ...
  for (i in exp_var){
    ...
    tbl2 <- glm(data[[paste0(type, ".p")]] ~ data[[i]], data = data, family = "binomial") %>%
            tbl_regression(exponentiate = TRUE,
                           label = list(`data[[i]]` ~ i)) %>%
...
multireg_table_int <- function(data){
  ...
  for (i in exp_var){
    ...
    tbl1 <- multinom(immunoscore_patients ~ data[[i]], data = data) %>%
            tbl_regression(exponentiate = TRUE, 
                           label = list(`data[[i]]` ~ i)) %>%
...
multireg_table_per <- function(data, type){
  ...
  for (i in exp_var){
    ...
    tbl2 <- multinom(immunoscore_patients ~ data[[i]], data = data) %>%
            tbl_regression(exponentiate = TRUE,
                           label = list(`data[[i]]` ~ i)) %>%
  multinom_pivot_wider()# %>%
...
multireg_table_int <- function(data){
  ...
  for (i in exp_var){
    ...
    tbl1 <- multinom(immunoscore_2018lancet_patients ~ data[[i]], data = data) %>%
            tbl_regression(exponentiate = TRUE,
                           label = list(`data[[i]]` ~ i)) %>%
  multinom_pivot_wider()# %>%
            # modify_spanning_header(everything() ~ paste("Association with Overall", "immunoscore_patients", "Intratumoral"))
...
multireg_table_per <- function(data){
  ...
  for (i in exp_var){
    ...
    tbl2 <- multinom(immunoscore_2018lancet_patients ~ data[[i]], data = data) %>%
            tbl_regression(exponentiate = TRUE,
                           label = list(`data[[i]]` ~ i)) %>%
  multinom_pivot_wider()# %>%
            # modify_spanning_header(everything() ~ paste("Association with Overall", "immunoscore_patients", "Peripheral"))
...
multireg_table_int <- function(data){
  ...
  for (i in exp_var){
    ...
    tbl1 <- multinom(clusters_all_IandP ~ data[[i]], data = data) %>%
            tbl_regression(exponentiate = TRUE,
                           label = list(`data[[i]]` ~ i)) %>%
  multinom_pivot_wider() #%>%
            # modify_spanning_header(everything() ~ paste("Association with Overall", "immunoscore_patients", "Intratumoral"))
...
multireg_table_per <- function(data){
  ...
  for (i in exp_var){
    ...
    tbl2 <- multinom(clusters_all_IandP ~ data[[i]], data = data) %>%
            tbl_regression(exponentiate = TRUE,
                           label = list(`data[[i]]` ~ i)) %>%
  multinom_pivot_wider() #%>%
            # modify_spanning_header(everything() ~ paste("Association with Overall", "immunoscore_patients", "Peripheral"))
